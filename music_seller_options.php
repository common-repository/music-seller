...
class music_seller_WPOptions {
    ...
    var $music_seller_show_preview = 1;

    var $music_seller_use_id3 = 1;
...
wp_dropdown_pages($args);
        ...
        <td><input type="text" size=50 name="music_seller_file_title" value="<?php echo get_option('music_seller_file_title',$op->music_seller_file_title); ?>" placeholder="%%artist%% - %%title%%" /></td>
        </tr>
